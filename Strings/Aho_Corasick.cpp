...
int buildMatchingMachine(string arr[], int k)
{
    ...
    // Now, let's build the fail function
    ...
    for (int ch = 0; ch < MAXC; ++ch)
    {
        // All nodes of depth 1 have fail function value
...
{
    // Preprocess patterns.
    // Build machine with goto, fail and output functions
